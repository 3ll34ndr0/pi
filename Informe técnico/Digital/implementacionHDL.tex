...
Y el segundo paso para crear el netlist, debemos especificar el valor real de sumador, por lo tanto valuamos el circuito con en número de bits del sumador y conseguiremos el archivo \verb_BrentKungFastAdder.vhl_ que mostramos en el apéndice \ref{vhdlNetlist} a modo de ejemplo:
\begin{lstlisting}
Main> fastAdder 8
