...
\subsection{Modificación al código fuente de la herramieta de síntesis lógica}
...
\item[Xyce] Simulador de circuitos con compatibilidad Spice, con mejoras para lograr simulaciones de millones de transistores con la misma precisión. Implementa alto nivel de paralelismo, \emph{solvers} iterativos mejorados y simula efectos de radiación (corriente de fotones y destrucción de neutrones).
\end{description}
...
\subsubsection{Medición de la performance}
\subsubsection{Medición de la potencia}

\subsection{Tablas comparativas de performance, potencia y área}
