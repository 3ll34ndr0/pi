...
\includegraphics[scale=0.7]{figuras/Silicon_chip_3d.png}
  \caption{Celda estándar con 3 capas de metales en color amarillo, y una capa de silício policristalino}
  \label{fig:routing}
\end{figure}
...
Electric & \multicolumn{1}{c}{Fácil instalación instalación instalación instalación instalación instalación } & No incluye celdas estándar caracterizadas \\ 
 & \multicolumn{1}{c}{Corre en GNU/Linux, Windows, MacOS} &                                           \\
 & \multicolumn{1}{c}{Todas las herramientas están integradas}  
 &                                           \\
