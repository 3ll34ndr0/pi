...
Aprovechamos estas celdas correctamente dimensionadas para lograr el apilamiento en filas y columnas. Para nuestros objetivos, modificamos las dimensiones de los transistores de canal P, para lograr un tiempo de crecida y bajada más simétricos, y así mejorar la velocidad.

Otra característica de estas celdas es la distancia entre el riel de VSS hasta el riel de VDD. Esta distancia es de 128 $\lambda$ (En nuestra tecnología de 180~$\mathrm{nm}$, el valor de lambda es: $\lambda = 100~\mathrm{nm}$), lo cual permite el ruteo horizontal de 16 pistas de metal por encima de las celdas, con metal 3 hasta capas superiories.

 \begin{figure}[h]
\centering
\includegraphics[scale=.7]{figuras/CeldEstandarAlto.eps}
  \caption{Plantilla para mostrar la grilla de interconexionado}
...
%                \centering
%                \includegraphics[scale=0.9]{figuras/and2_1x.png}
%                \caption{and2_1x}
%                \label{fig:lay_and2_1x}
%        \end{subfigure}
%\begin{subfigure}[b]{0.20\textwidth}
%                \centering
%                \includegraphics[scale=1]{figuras/or2_1x.png}
%                \caption{or2_1x}
%                \label{fig:lay_or2_1x}
%        \end{subfigure}
%\begin{subfigure}[b]{0.20\textwidth}
%                \centering
%                \includegraphics[scale=1]{figuras/xor2_1x.png}
%                \caption{xor2_1x}
%                \label{fig:lay_xor2_1x}
%        \end{subfigure}
%\begin{subfigure}[b]{0.20\textwidth}
%                \centering
%                \includegraphics[scale=1]{figuras/id_1x.png
%                \caption{buffer}
%                \label{fig:lay_id_1x}
%        \end{subfigure}
%  \caption{4 celdas estándar}\label{fig:lay_standarCells}
%\end{figure}
...
\subsection{Sumadores de 8 bits}
A modo de ejemplo ilustrativo, mostramos el layout de los 3 sumadores para el tamaño de 8 bits.

% Layout de Ripple Carry 8 bits
\begin{figure}[h]
\centering
\includegraphics[scale=0.7]{figuras/lay_ripplecarry8bits.png}
  \caption{Ripple Carry 8 bits}
  \label{fig:lay_rc8}
\end{figure}


% Layout de Skalansky 8 bits
\begin{figure}[h]
\centering
\includegraphics[scale=0.55]{figuras/lay_skalansky8bits.png}
  \caption{Layout del sumador Skalansky 8 bits}
  \label{fig:lay_sk8}
\end{figure}

% Layout de Brent-kung 8 bits
\begin{figure}[h]
\centering
\includegraphics[scale=0.55]{figuras/lay_brentkung8bits.png}
  \caption{Layout del sumador Brent-Kung 8 bits}
  \label{fig:lay_bk8}
\end{figure}
