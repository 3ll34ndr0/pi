...
\newacronym{drc}{DRC}{Design Rule Check. Verificación de las dimensiones físicas del \cursi{layout} para evitar violaciones a las reglas que el proceso de fabricación del chip impone, para evitar efectos no deseados (corto circuitos, tensiones internas del chip que lo puedan quebrar, etc)}
...
\newglossaryentry{spice}{name={SPICE},description={Simulation Program with Integrated Circuit Emphasis. Motor de simulación a nivel de transistores y elementos pasivos. Estándard de facto para la simulación de circuitos analógicos por su alta precisión. Existen muchas implementaciones, siendo las más conocidas PSPICE, HSPICE, spectre, ngspice, LTSPICE, entre otros. Cada implementación no es compatible (por su sintáxis) con las otras, aunque dependiendo del caso se puede salvar con pequeñas modificaciones}}
