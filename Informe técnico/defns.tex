...
\newglossaryentry{cmp}{name={CMP},description={Organización que presta el servicio para la fabricación de circuitos integrados y \gls{mems} para prototipado y bajo volumen de producción. Sitio web: http://cmp.imag.fr/}}

\newglossaryentry{mems}{name={MEMS},description={Microelectromechanical systems, sistemas microelectromecánicos.}}
