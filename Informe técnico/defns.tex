...
\newglossaryentry{cmp}{name={CMP},description={Organización dedicada a la fabricación de circuitos integrados y \gls{mems} para prototipado y bajo volumen de producción. Sitio web: http://cmp.imag.fr/}
