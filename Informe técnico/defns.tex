...
\newglossaryentry{tapeout}{name={TAPEOUT},description={Palabra históricamente utilizada para denominar el momento de finalizar todo el diseño y enviar el proyecto en formato \gls{gdsii} a la fábrica para que realicen el chip}}
\newglossaryentry{gdsii}{name={GDSII},description={Estándar utilizado por el software de diseño de circuitos integrados para entregar a la fábrica que realizará nuestro chip. En ese archivo se contiene toda la información necesaria para llevar adelante todo el proceso de fabricación}}
