...
-- Parece que tengo que hacer la función peine usando un bufer
peine' (buf, op) []     = []
peine' (buf, op) [a]    = []
...
--append (a, b) = a ++ b -- ya está definido en Paterns.hs
...
--
-- buf (gin,pin) = (gin, pin)
-- This I did on Aug 15 2010 (leandro)
buf = inverter ->- inverter
...
--{- La cambio para hacer una versión que ya tenga fijo el dot operator
bKung _ [a] = []
