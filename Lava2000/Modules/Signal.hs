...
-- New version of Delay: Dly 
dlyBool :: Signal Bool -> Signal Bool
dlyBool = lift1 DlyBool
...
--version
    DlyBool s      -> wrong Error.DlyEval
    DlyInt  s      -> wrong Error.DlyEval
...
--version
    DlyBool s -> map DlyBool s
    DlyInt  s -> map DlyInt s
...
-- New version of Delay: Dly 
      DlyBool x -> lift1 DlyBool x 
      DlyInt  x -> lift1 DlyInt x 
...
-- New version of Delay: Dly 
      DlyBool x -> showString "dly" . showList [x]
      DlyInt  x -> showString "dly" . showList [x]
